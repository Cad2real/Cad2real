...
# Function: convert quaternion and translation vector into a 4x4 transform matrix
def transform_matrix(translation, quaternion):
    ...
    # Construct the 4x4 transform matrix
    transform = np.eye(4)
...
def extract_transform(matrix):
    ...
    # Convert quaternion to [qw, qx, qy, qz]
    return translation, [quat[3], quat[0], quat[1], quat[2]]

# 1. Pose of frame C relative to frame A
# trans.py
