...
from control.linker_hand_python_sdk.LinkerHand.utils.load_write_yaml import LoadWriteYaml
from control.linker_hand_python_sdk.LinkerHand.utils.color_msg import ColorMsg
'''
LinkerHand图形控制
'''
...
JUQ_SENSOR_IDX = {
    "thumb":  209,  # sensor_256[210-1]
    "index":  212,  # sensor_256[213-1]
    "middle": 215,  # sensor_256[216-1]
    "ring":   218,  # sensor_256[219-1]
    "pinky":  221,  # sensor_256[222-1]
    "index_thumb_middle_1": 146,  # 147-1
    "index_thumb_middle_2": 178,  # 179-1
    "index_thumb_middle_3": 147,  # 148-1
    "thumb_roll": 147,  # 148-1
}

# 矩侨手套压电传感器弯曲范围（左手）
JUQ_CALIB = {
    "thumb":  {"RAW_MIN":  30, "RAW_MAX": 102},  # TODO
    "index":  {"RAW_MIN":  88, "RAW_MAX": 150},  # TODO
    "middle": {"RAW_MIN":  128, "RAW_MAX": 155},  # TODO
    "ring":   {"RAW_MIN":  118, "RAW_MAX": 160},  # TODO
    "pinky":  {"RAW_MIN":  56, "RAW_MAX": 96},  # TODO
    "thumb_roll": {"RAW_MIN": 0.0, "RAW_MAX": 20.0},
}

# ===== thumb_cmc_yaw 三路信号标定（TODO：实测后改）=====
CALIB_YAW_RAW = {
    "index_thumb_middle_1": {"RAW_MIN": 0.0, "RAW_MAX": 15.0},
    "index_thumb_middle_2": {"RAW_MIN": 0.0, "RAW_MAX": 32.0},
